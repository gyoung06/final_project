								...
								<div class="panel-body">
									...
									<div class="property-type-box p-3 p-x-7">
										...
										<button
											...
											onclick="location.href='${pageContext.request.contextPath }/hjy/hotelInsert2?type='+'privateHouse'">
											<span>선택하기</span>
										</button>
									</div>
									<div class="property-type-box p-3 p-x-7">
										...
										<button
											...
											onclick="location.href='${pageContext.request.contextPath }/hjy/hotelInsert2?type='+'hotelBnB'">
											<span>선택하기</span>
										</button>
									</div>
								</div>
